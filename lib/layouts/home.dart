...
import 'package:aplikasi_pertama/component/icon.dart';
import 'package:aplikasi_pertama/layouts/deposito.dart';
import 'package:aplikasi_pertama/layouts/login.dart';
import 'package:aplikasi_pertama/component/detailbox.dart';
import 'package:aplikasi_pertama/layouts/mutasi.dart';
import 'package:aplikasi_pertama/layouts/pembayaran.dart';
import 'package:aplikasi_pertama/layouts/pinjaman.dart';
import 'package:aplikasi_pertama/layouts/transfer.dart';
                                    ...
                                    ResponsiveRowColumnItem(
                                      child: Container(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: Image(
                                            image: AssetImage(
                                                'images/I Kade Kurnia Meiarta.jpg'),
                                          ),
                                        ),
                                      ),
                                    ),
                                        ...
                                        children: [
                                          ResponsiveRowColumnItem(
                                            child: detailbox('Nasabah',
                                                'I Kade Kurnia Meiarta'),
                                          ),
                                          ResponsiveRowColumnItem(
                                              child: detailbox(
                                                  'Total Saldo', '2.800.000')),
                                        ],
                                      ),
                                    ),
                                  ],
